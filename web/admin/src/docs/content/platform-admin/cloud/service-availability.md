...
On OpenStack 2025.1 or 2026.1 (kolla-ansible), Octavia, Manila, and Ceph RGW-backed object storage work out of the box — but only switch them on in regions where the backing service is genuinely deployed.
