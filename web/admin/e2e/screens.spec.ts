...
// Output: e2e/shots/<name>-<theme>-<viewport>.png — the gallery reviewed
// during the restyle. Not a pixel-diff suite; it asserts the page rendered
// (no auth wall, no crash) and captures the state of the world.
